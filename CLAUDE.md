...
npm test           # vitest run — 2,749 permanent tests in the last reported run
...
2,749 permanent tests passed in the last reported run, Vitest + Testing Library, co-located
