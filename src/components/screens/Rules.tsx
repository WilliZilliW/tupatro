  ...
  return (
    <Overlay>
      ...
      <div className="rules">
        ...
        <h3>{t("rules.challengeTitle")}</h3>
        <ul>
          {tList("rules.challenge").map((x, i) => (
            <li key={i}>
              <Rich text={x} />
            </li>
          ))}
        ...
        <h3>{t("rules.raceTitle")}</h3>
        <ul>
          {tList("rules.race").map((x, i) => (
            <li key={i}>
              <Rich text={x} />
            </li>
          ))}
        ...
        <h3>{t("rules.tradTitle")}</h3>
        <ul>
          {tList("rules.trad").map((x, i) => (
            <li key={i}>
              <Rich text={x} />
            </li>
          ))}
        ...
        <h3>{t("rules.tupatroTitle")}</h3>
        <ul>
          {tList("rules.tupatro").map((x, i) => (
            <li key={i}>
              <Rich text={x} />
            </li>
          ))}
        ...
        <h3>{t("rules.rpsTitle")}</h3>
        <ul>
          {tList("rules.rps").map((x, i) => (
            <li key={i}>
              <Rich text={x} />
            </li>
          ))}
        ...
        <h3>{t("rules.politiikkaTitle")}</h3>
        <ul>
          {tList("rules.politiikka").map((x, i) => (
            <li key={i}>
              <Rich text={x} />
            </li>
          ))}
