...
/* Politiikka's own suit marks: a stylised clover, dandelion, bird and
   cornflower in place of the ordinary suit glyph for clubs, spades, hearts
   and diamonds, only in this mode — the ordinary glyph stays everywhere
   ...
   they used to sit in front of did. All four suits get an icon here now;
   there is no corner badge any more. Two more honours exist in this mode
   alone: ♦K and ♠Q are drawn as caricatures of Kokoomus's and
   Perussuomalaiset's own party leaders, Politiikka-only rather than
   unconditional — everywhere else, ♦K and ♠Q draw the plain text glyph
   like any other card of their suit. */
