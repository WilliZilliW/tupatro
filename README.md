...
alone**: a four-leaf clover for clubs, a cornflower for diamonds, a dandelion (voikukka) for
spades and a V-shaped bird in flight for hearts — a second, purely visual joke sitting beside the
...
and Queen of Spades carry the same joke one step further**, as caricatures — hand-drawn cartoons,
not photographs — of two of those same real parties' own leaders, in this mode alone; every other
mode draws the ordinary suit pip for all four suits, this mode's own ♦K and ♠Q included. **A
deal's worth is the parties
of the cards a
